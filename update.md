...
1. Corgi add progress #248 on assignment 2, CSC 369♥♥
    - Corgi working on `msg_queue_poll` #108
        - Corgi working on adding code
        - Corgi working on ready feature #4
        - Corgi working on fixing compile errors #2
