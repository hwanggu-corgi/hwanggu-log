...
2. Corgi working on practicing docker certified associate exam♥♥ #10
    - 자기야♥♥♥♥, 요기 우리 링크♥♥♥♥♥♥
        - https://www.udemy.com/course/docker-certified-associate/learn/lecture/19190958#overview
            - Corgi working on lesson (7/21) `Docker Image Vs Docker Containers` under `Getting Started With Dockers`♥♥♥♥ #5
