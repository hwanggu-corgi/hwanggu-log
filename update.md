...
1. Corgi add progress #36 on back-end engineer path from Codeacademy♥♥
    - Corgi working on Lesson 10 - Build a Back-End with Node/Express.js
        - Corgi working on `Learn Node.js` (8/15) #13
            - Corgi working on derivative derivative lesson `Javascript Promises` (8/11)
            - Corgi completed working on derivative lesson `Javascript Promises` (7/11)
