...
1. Corgi add progress #35 on back-end engineer path from Codeacademy♥♥
    - Corgi working on Lesson 10 - Build a Back-End with Node/Express.js
        - Corgi working on `Learn Node.js` (8/15) #12
            - Corgi working on derivative derivative lesson `Javascript Promises` (7/11)
            - Corgi completed working on derivative lesson `Javascript Promises` (6/11)
