...
1. Corgi add progress #611 on practicing coding interview♥♥
    - Corgi add progress #3 on problem `Count Factors` in Codility (Python)♥♥
    ...
    - [on hold] Corgi add progress on problem `Flags` in Codility (Python)♥♥
