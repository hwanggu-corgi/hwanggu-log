...
2. Corgi working on mini projects♥♥
    - Corgi add progress #129 on project `Learn Typescript`♥♥
        - Corgi add progress #27 on chapter 4 - Union Types♥♥
            - Corgi working on step (12/22) for the project `Unionversity`♥♥ #8
