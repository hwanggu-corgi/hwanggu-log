...
1. Corgi add progress #602 on practicing coding interview♥♥
    - Corgi add progress #11 on problem `Flags` in Codility (Python)♥♥
        - 여보 요기 링쿠♥♥!!: https://app.codility.com/programmers/lessons/10-prime_and_composite_numbers/flags/
            - Corgi adding code to function `get_flags_amount`♥♥ #5
