...
1. Corgi add progress #691 on practicing coding interview♥♥
    - Corgi add progress #15 on problem `단어 변환` in Programmers (Python)♥♥
        - 여보 요기 링쿠♥♥!!: https://programmers.co.kr/learn/courses/30/lessons/43163
            - Corgi fixing failure in test case 3♥♥ #2
