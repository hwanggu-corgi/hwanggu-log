...
1. Corgi add progress #8 on assignment 2, CSC 369♥♥
    - Corgi working on adding code to `msg_queue_open` #4
        - Moe corgi working on gathering notes on `conditional variable`, over♥♥ #2
