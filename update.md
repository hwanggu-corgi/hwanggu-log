...
1. Corgi add progress #4 on hyungmogu.com♥♥
    - Corgi fixing hyungmogu.com not pointing to https://hwanggu-corgi.github.io/portfolio-site/ #7
        - Corgi waiting until change a effect♥♥
    - Corgi working on converting static template to dynamic template for `works page` #12
        - Corgi adding data
