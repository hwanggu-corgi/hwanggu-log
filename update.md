...
4. Corgi working on creating Chat application♥♥ #71
    - Corgi working on backend of the chat application♥♥ #37
        - Corgi completed fixing chat posts being created without userid♥♥
    - Corgi working on frontend of the chat application♥♥ #57
        - Corgi fixing empty texts being sent to server on submit♥♥
        - Corgi working on refining the view of chat screen♥♥ #10
