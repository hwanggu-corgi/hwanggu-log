...
1. Corgi add progress #13 on assignment 2, CSC 369♥♥
    - Corgi working on adding code to `msg_queue_open` #5
        - Moe corgi working on gathering notes on `conditional variable`, over♥♥ #3
        - Moe corgi working on gathering notes on `producer and consumer`, over♥♥
