...
1. Corgi add progress #681 on practicing coding interview♥♥
    - Corgi add progress #5 on problem `단어 변환` in Programmers (Python)♥♥
        - 여보 요기 링쿠♥♥!!: https://programmers.co.kr/learn/courses/30/lessons/43163
            - Corgi adding code♥♥ #2
                - Corgi working on adding function `is_one_char_apart`
