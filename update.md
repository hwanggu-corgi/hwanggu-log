...
1. Corgi add progress #250 on assignment 2, CSC 369♥♥
    - Corgi working on `msg_queue_poll` #110
        - Corgi working on adding code
        - Corgi working on ready feature #5
        - Corgi working on fixing compile errors #3
