...
2. Corgi working on mini projects♥♥
    - Corgi add progress #98 on project `Learn Typescript`♥♥
        - Corgi add progress #30 on lesson 4 - Custom Types♥♥
            - Corgi working on step (10/15) for the project `Restaurant Orders`♥♥ #8
