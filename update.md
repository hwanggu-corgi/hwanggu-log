...
2. Corgi working on mini projects♥♥
    - Corgi add progress #130 on project `Learn Typescript`♥♥
        - Corgi add progress #28 on chapter 4 - Union Types♥♥
            - Corgi working on step (13/22) for the project `Unionversity`♥♥ #9
