...
1. Corgi add progress #251 on assignment 2, CSC 369♥♥
    - Corgi working on `msg_queue_poll` #111
        - Corgi working on adding code
        - Corgi working on ready feature #6
        - Corgi working on fixing compile errors #4
