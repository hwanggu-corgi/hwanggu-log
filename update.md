...
1. Corgi add progress #29 on assignment 2, CSC 369♥♥
    - Corgi working on adding code to `msg_queue_open` #7
        - Moe corgi working on gathering notes on `read and write` #1, over♥♥
