...
1. Corgi add progress #34 on back-end engineer path from Codeacademy♥♥
    - Corgi working on Lesson 10 - Build a Back-End with Node/Express.js
        - Corgi working on `Learn Node.js` (8/15) #11
            - Corgi working on derivative derivative lesson `Javascript Promises` (6/11)
            - Corgi completed working on derivative lesson `Javascript Promises` (5/11)
