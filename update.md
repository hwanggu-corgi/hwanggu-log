...
3. Corgi working on hyungmogu.com dashboard♥♥
    - Corgi integrating front-end dashboard to backend♥♥ #93
        - Corgi working on adding DELETE call on `/social/:id`♥♥ #4
        - Corgi working on adding DELETE call on `/contact/:id`♥♥ #4
