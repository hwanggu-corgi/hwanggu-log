...
1. Corgi add progress #111 on hyungmogu.com♥♥
    - Corgi fixing hyungmogu.com not pointing to https://hwanggu-corgi.github.io/portfolio-site/ #11
        - Corgi waiting until change a effect♥♥
    - Corgi working on converting static template to dynamic template for `works detail page` #3
        - Corgi adding code
