...
3. Corgi working on practicing algorithm for Mobsquad♥♥ #45
    - Corgi working on question `전화번호 목록` in Programmers♥♥ #2
        - 여보♥♥, 요기 우리 링크♥♥♥♥
...
3. Corgi working on practicing algorithm for Mobsquad♥♥ #31
