...
2. Corgi working on mini projects♥♥
    - Corgi add progress #97 on project `Learn Typescript`♥♥
        - Corgi add progress #29 on lesson 4 - Custom Types♥♥
            - Corgi working on step (7/15) for the project `Restaurant Orders`♥♥ #7
