### October 18th, 2020
1. Corgi add progress #186 in csc-369-assignment-1♥♥
    - Corgi working on a1fs_mkdir in a1fs.c, over♥♥
        - Corgi working on adding code #9
            - Corgi working on adding helper function `get_parent_path`
            - Corgi adding comments and correcting variable names and double checking surface-level code #5
