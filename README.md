...
1. Worked on practicing coding interview
    - Completed problem `가장 큰 수` in Programmers (Javascript)
    - Completed problem `다리를 지나는 트럭` in Programmers (Javascript)

### December 17th, 2020

1. Worked on practicing coding interview
    - Completed problem `땅따먹기` in Programmers (Javascript)
    - Completed problem `위장` in Programmers (Javascript)
    - Completed problem `예상 대진표` in Programmers (Javascript)
    - Completed problem `구명보트` in Programmers (Javascript)
    - Completed problem `올바른 괄호` in Programmers (Javascript)
    - Completed problem `프린터` in Programmers (Javascript)
    - Completed problem `문자열 내림차순으로 배치하기` in Programmers (Javascript)
    - Completed problem `정수 내림차순으로 배치하기` in Programmers (Javascript)
...
### December 14th, 2020
1. Worked on practicing coding interview
    - Completed problem `수식 최대화` in Programmers
